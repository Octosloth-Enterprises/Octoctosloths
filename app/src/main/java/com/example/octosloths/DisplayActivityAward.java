...
public class DisplayActivityAward extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{ // hola amogus
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_award); // new xml, very similar to activity_main

        // setting title of page
        setTitle("Award Entries");

        // setting toolbar for new xml
        Toolbar toolbar = findViewById(R.id.toolbar_display_award);
        setSupportActionBar(toolbar); // setting toolbar as action bar
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        drawer = (DrawerLayout) findViewById(R.id.drawer_layout_display_award);
        // drawerToggle = setupDrawerToggle();

        NavigationView navigationView = findViewById(R.id.nav_view_display_award);
        ...
        FloatingActionButton buttonAddNote = findViewById(R.id.button_add_note_display_award);
        buttonAddNote.setOnClickListener(new View.OnClickListener() { // setting onclicklistener, when clicked will open new page
            ...
            PopupMenu popupMenu = new PopupMenu(DisplayActivityAward.this, buttonAddNote);
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    if (id == R.id.one) { // basic
                        ...
                        Intent intent1 = new Intent(DisplayActivityAward.this, AddNoteActivityBasic.class);
                        startActivityForResult(intent1, ADD_NOTE_REQUEST); // method to start activity and get input back
                        return false;
                    }
                    if (id == R.id.two) { // volunteering

                        Intent intent2 = new Intent(DisplayActivityAward.this, AddNoteActivityVolunteering.class);
                    ...
                    if (id == R.id.three) { // extracurricular
                        ...
                        Intent intent2 = new Intent(DisplayActivityAward.this, AddNoteActivityExtracurricular.class);
                        startActivityForResult(intent2, ADD_NOTE_REQUEST); // method to start activity and get input back
                        return false;
                    }
                    if (id == R.id.four) { // education

                        Intent intent2 = new Intent(DisplayActivityAward.this, AddNoteActivityEducation.class);
                        startActivityForResult(intent2, ADD_NOTE_REQUEST); // method to start activity and get input back
                        return false;
                    }
                    if (id == R.id.five) { // award

                        Intent intent2 = new Intent(DisplayActivityAward.this, AddNoteActivityAward.class);
                        startActivityForResult(intent2, ADD_NOTE_REQUEST); // method to start activity and get input back
                        return false;
                    }
                    return DisplayActivityAward.super.onOptionsItemSelected(item);
                }
            });
                popupMenu.show();
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_display_award);
        ...
        noteViewModel.getAllAwardNotes().observe(this, new Observer<List<Note>>() {
        ...
        new ItemTouchHelper((new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(DisplayActivityAward.this, "Note deleted", Toast.LENGTH_SHORT).show();
            }
        ...
        noteAdapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Note note) {
                ...
                Intent intent = new Intent(DisplayActivityAward.this, AddNoteActivityAward.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {// opens fragments
        switch (item.getItemId()) {
            case R.id.nav_basicentry: //opens Basic Entries fragment
                ...
                Intent intent1 = new Intent(DisplayActivityAward.this, DisplayActivityBasic.class);
            ...
            case R.id.nav_awardentry: //opens Award Entries fragment
                ...
                Intent intent2 = new Intent(DisplayActivityAward.this, DisplayActivityAward.class);
            ...
            case R.id.nav_educationentry: //opens Education Entries fragment
                ...
                Intent intent3 = new Intent(DisplayActivityAward.this, DisplayActivityEducation.class);
            ...
            case R.id.nav_extracurricularentry: //opens Extracurricular Entries fragment
                ...
                Intent intent4 = new Intent(DisplayActivityAward.this, DisplayActivityExtracurricular.class);
            ...
            case R.id.nav_volunteerentry: //opens Volunteer Entries fragment
                ...
                Intent intent5 = new Intent(DisplayActivityAward.this, DisplayActivityVolunteering.class);
