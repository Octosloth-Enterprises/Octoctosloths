...
public class AddNoteActivityEducation extends AppCompatActivity { // for the adding note page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // start date
       mDisplayDate = (TextView) findViewById(R.id.textView7_education);
       mDisplayDate.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               DatePickerDialog dialog = new DatePickerDialog(AddNoteActivityEducation.this,
       ...
       mDateSetListener = new DatePickerDialog.OnDateSetListener() { // when date has been set
           ...
           public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
               ...
               Toast.makeText(AddNoteActivityEducation.this, "set display text 1 to: " + mDisplayDate.getId(), Toast.LENGTH_SHORT).show();
       ...
       // end date
        mDisplayDate2 = (TextView) findViewById(R.id.textView8_education); // ???
        ...
        mDateSetListener2 = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                Toast.makeText(AddNoteActivityEducation.this, "set display text 2 to: " + mDisplayDate2.getId(), Toast.LENGTH_SHORT).show();
        ...
        editTextTitle = findViewById(R.id.edit_text_title_education);
        editTextDescription = findViewById(R.id.edit_text_description_education);
        editTextGpa = findViewById(R.id.edit_text_gpa_education);

        Log.v("AddNoteActivity: ", "onCreate entered");

        // getting menu bar and setting icons
        Toolbar toolbar = findViewById(R.id.toolbar_add_note_education);
    ...
    private void saveNote() {
        ...
        String gpa = editTextGpa.getText().toString(); // getting GPA
